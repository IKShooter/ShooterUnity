...
Shader "Skybox/Starlit Skybox"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutput o )
		{
			...
			o.Emission = ( ( texCUBE( _HDR_Stars, rotatedValue109 ) * _StarsBrightness ) + ( ( lerpResult85 + texCUBE( _E_Moon, i.viewDir )*1.0 ) + ( ( ( texCUBE( _Cloud2, ( rotatedValue67 + temp_output_100_0 ) ) + texCUBE( _Cloud1, ( rotatedValue30 + temp_output_100_0 ) ) ) * _CloudOpacity ) * lerpResult113 ) ) ).rgb;
			o.Alpha = 1;
		}
